            ...
            <div class="col-lg-6">
                <div class="signup-warp">
                    <div class="section-title text-left">
                        <h2>{{ __("¿Quieres ser instructor en :app  Perú?", ["app" => env('APP_NAME')]) }}</h2>
                    ...
                    >
                        ...
                        >
                        <button class="site-btn" style="border-radius: 0.5rem; width: 25rem;">{{ __("Crear cuenta de instructor") }}</button>
                    </form>
