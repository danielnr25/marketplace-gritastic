...
namespace  {
             ...
             * @static
             */
            public static function forPage($page, $perPage = 12)
            {
                                /** @var \Illuminate\Database\Query\Builder $instance */
             ...
             * @static
             */
            public static function forPageBeforeId($perPage = 12, $lastId = 0, $column = 'id')
            {
                                /** @var \Illuminate\Database\Query\Builder $instance */
             ...
             * @static
             */
            public static function forPageAfterId($perPage = 12, $lastId = 0, $column = 'id')
            {
                                /** @var \Illuminate\Database\Query\Builder $instance */
